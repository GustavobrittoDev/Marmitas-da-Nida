...
export function Icon({ name, className }: IconProps) {
  switch (name) {
    ...
    case 'whatsapp':
      return (
        <SvgIcon className={className}>
          <path d="M12 4a8 8 0 0 0-6.9 12.04L4 20l4.13-1.08A8 8 0 1 0 12 4Z" />
          <path d="M9.5 9.3c.2-.5.4-.5.7-.5h.6c.2 0 .5 0 .7.5.2.6.7 1.6.7 1.7.1.2 0 .4-.1.5l-.4.5c-.2.2-.3.3-.1.6.4.8 1.1 1.4 1.9 1.8.3.2.5.1.6-.1l.5-.6c.2-.2.4-.2.6-.1l1.3.6c.2.1.4.2.4.5 0 .3-.2 1.5-.9 2-.7.5-1.4.5-1.8.4-.4-.1-1.8-.7-3-1.9-1.2-1.1-2-2.6-2.2-3.1-.1-.5 0-1.1.3-1.5.4-.5.8-.8 1-.8Z" />
        </SvgIcon>
      );
    case 'cart':
      return (
